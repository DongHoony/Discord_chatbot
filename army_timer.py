...
army_day    = {"신나무":datetime(2019, 4, 16, 14, 0, 0, tzinfo=KST), "이동훈":datetime(2020, 3, 9, 14, 0, 0, tzinfo=KST),
...
freedom_day = {"신나무":datetime(2020, 11, 16, 0, 0, 0, tzinfo=KST), "이동훈":datetime(2022, 1, 8, 0, 0, 0, tzinfo=KST),
               "김용진":datetime(2021, 8, 7, 0, 0, 0, tzinfo=KST), "김겨레":datetime(2022, 2, 3, 0, 0, 0, tzinfo=KST)}
...
def get_name(string):
    ...
    if "나무" in string:
        return "신나무"
    if "용진" in string or "복숭아" in string:
        return "김용진"
